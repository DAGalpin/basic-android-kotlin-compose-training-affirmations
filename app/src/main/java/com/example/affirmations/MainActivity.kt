...
class MainActivity : AppCompatActivity() {
    ...
    // TODO: (3) Register for pick media result with PickMultipleMedia result contract
    // TODO: (4) Use callback to update view model - setaffirmation
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AffirmationApp(model,
                onLanguageSelected = {
                    // TODO: (1) Use AppCompat with AppCompatDelegate
                ...
                onClicked = {
                    // TODO: (5) Check if isPhotoPickerAvailable
                    // TODO: (6) Launch with the type of media - photos AND videos
                })
        }
    }
}
